...
@Component({
  selector: 'app-cashapp-gateway',
  templateUrl: './cashapp-gateway.component.html',
  styleUrls: ['./cashapp-gateway.component.scss']
})
export class CashappGatewayComponent extends PaymentBaseComponent implements OnInit, OnDestroy {
