...
@Component({
  selector: 'app-oxxo-gateway',
  templateUrl: './oxxo-gateway.component.html',
  styleUrls: ['./oxxo-gateway.component.scss']
})
export class OxxoGatewayComponent extends PaymentBaseComponent implements OnInit, OnDestroy {
