...
import { Component, OnInit, Input, HostListener, Inject, ChangeDetectionStrategy } from '@angular/core';
...
@Component({
    selector: 'app-food-new-restaurant',
    templateUrl: './food-new-restaurant.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class FoodNewRestaurantComponent implements OnInit {
