(function () {
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["firebase-analytics"], {
    ...
    function node_modulesFirebaseAnalyticsDistIndexEsmJs(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! tslib */
      "./node_modules/ngx-quicklink/node_modules/tslib/tslib.es6.js");
      /* harmony import */
      ...
      ] = 'Firebase Analytics Interop Component failed to instantiate: {$reason}', _a["indexedDB-unsupported"
      ...
      ] = 'Firebase Analytics is not supported in browser extensions.', _a["fetch-throttle"
      /* FETCH_THROTTLE */
      ...
      /* NO_APP_ID */
      ] = 'The "appId" field is empty in the local Firebase config. Firebase Analytics requires this field to' + 'contain a valid app ID.', _a["indexedDB-unsupported"
      /* INDEXED_DB_UNSUPPORTED */
      ] = 'IndexedDB is not supported by current browswer', _a["invalid-indexedDB-context"
      /* INVALID_INDEXED_DB_CONTEXT */
      ] = "Environment doesn't support IndexedDB: {$errorInfo}. " + 'Wrap initialization of analytics in analytics.isSupported() ' + 'to prevent initialization in unsupported environments', _a["cookies-not-enabled"
          ...
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_c) {
            switch (_c.label) {
              case 0:
                ...
                return [4
                /*yield*/
                , Promise.all([dynamicConfigPromise, installations.getId()])];
              ...
              case 1:
                ...
                gtagCore(GtagCommand.CONFIG, dynamicConfig.measurementId, (_b = {}, _b[GA_FID_KEY] = fid, // guard against developers accidentally setting properties with prefix `firebase_`
      ...
      function factory(app, installations) {
        ...
        Object(_firebase_util__WEBPACK_IMPORTED_MODULE_4__["validateIndexedDBOpenable"])()["catch"](function (error) {
          var analyticsError = ERROR_FACTORY.create("invalid-indexedDB-context"
          /* INVALID_INDEXED_DB_CONTEXT */
          , {
            errorInfo: error
          });
